...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.imageLeft = QtWidgets.QGraphicsView(Dialog)
        self.imageLeft.setGeometry(QtCore.QRect(10, 50, 301, 221))
        ...
        self.imageLeft_2 = QtWidgets.QGraphicsView(Dialog)
        self.imageLeft_2.setGeometry(QtCore.QRect(180, 390, 301, 221))
