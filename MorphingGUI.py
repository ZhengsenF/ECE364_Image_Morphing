...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.imageLeftViewer.setGeometry(QtCore.QRect(10, 50, 311, 221))
        self.imageLeftViewer.setObjectName("imageLeftViewer")
        self.imageRightViewer = QtWidgets.QGraphicsView(Dialog)
        self.imageRightViewer.setGeometry(QtCore.QRect(330, 50, 311, 221))
        self.imageRightViewer.setObjectName("imageRightViewer")
        ...
        self.imageBlendViwer = QtWidgets.QGraphicsView(Dialog)
        self.imageBlendViwer.setGeometry(QtCore.QRect(180, 390, 301, 221))
        self.imageBlendViwer.setObjectName("imageBlendViwer")
